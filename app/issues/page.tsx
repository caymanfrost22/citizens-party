...
const issueRoutes: Record<string, string> = {
  ...
  'Energy Policy': '/issues/energy',
  'Nuclear': '/issues/energy',
  'Nuclear Power': '/issues/energy',
  'SMR': '/issues/energy',
  'LNG': '/issues/energy',
  'Natural Gas': '/issues/energy',
  'Oil': '/issues/energy',
  'Coal': '/issues/energy',
  'Renewables': '/issues/energy',
  'Solar': '/issues/energy',
  'Wind': '/issues/energy',
  'Geothermal': '/issues/energy',
  'Fusion': '/issues/energy',
  'EV': '/issues/energy',
  'Electric Vehicles': '/issues/energy',
  'Grid': '/issues/energy',
  'Transmission': '/issues/energy',
  'Permitting': '/issues/energy',
  'SPR': '/issues/energy',
  'Strategic Petroleum Reserve': '/issues/energy',
