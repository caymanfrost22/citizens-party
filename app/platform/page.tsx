...
const PILLARS: Pillar[] = [
  ...
  },
  {
    ...
    title: 'Social',
    color: 'var(--green)',
    catchphrase: 'Invest in people. Equip them to thrive.',
    subtitle: 'Six sub-issues, all shipped — education, crime + criminal justice, drug policy, healthcare access, the Second Amendment, and abortion. The hardest debates met with the honest middle the poles refuse to name. Immigration shipped standalone.',
    status: 'shipped',
    subIssueCount: 6,
    href: '/issues/social',
  },
  {
    ...
    subtitle: 'Four sub-issues, all shipped — Military Posture & Defense Doctrine, Ukraine/Israel/Foreign Wars, China Policy, and the full NATO + Alliances architecture restructured on pay-to-play, mutual-defense only, no permanent enemies. The deepest version of "no permanent enemies": the alliance is open. Everyone plays by the rules. Everyone wins.',
    status: 'shipped',
    subIssueCount: 4,
    href: '/issues/foreign',
  },
...
const CATCHPHRASES: Catchphrase[] = [
  ...
  {
    text: 'Real allies. Real rules. Real exits.',
    context: 'NATO reaffirmed and put on a 3% floor with tiered protection — pay more, get more. Miss the floor two years running, lose Article 5 until current. Every treaty and alliance commitment on a mandatory 10-year sunset. New alliances require Article I approval + mutual-defense-only doctrine + cost-share floor + defined exit clause. Clean withdrawal procedure written into law instead of improvised.',
    pillar: 'Foreign',
    color: '#7b2d8b',
  },
  {
    text: 'Everyone plays by the rules. Everyone wins.',
